<?php
	if(count($_POST)>0) {
		...
		$query = $pdo->prepare("INSERT INTO user (user_id, f_name, l_name, username, user_password) values ('$di', '$f', '$l', '$u', '$p')");
		$query->execute();
        ...
        <div class="container">
            <div class="hero-unit">
				...
				<form action="" method="post">
                    ...
                    <div class="mb-3">
                            <label for="artist_id" class="form-label"><b>Artist ID</b></label>
							<input type="int" class="form-control" name="artist_id">
                    </div>
